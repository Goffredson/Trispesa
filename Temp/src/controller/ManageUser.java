...
//					req.getSession().setAttribute("message", "Il metodo di pagamento � stato eliminato con successo!");
...
//
//					req.getSession().setAttribute("result", "true");
//					req.getSession().setAttribute("message", "L'indirizzo di consegna � stato eliminato con successo!");
//					resp.sendRedirect("../user?page=profile");
//				}
//					break;
//				}
